                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="d-flex justify-content-start flex-column">
                                            <a href="{{route('admin.users.show',$banner->user_id)}}"
                                                class="text-dark fw-bolder text-hover-primary fs-6">{{$banner->user->name ?? ""}}</a>
                                            <span
                                                class="text-muted fw-bold text-muted d-block fs-7">{{$banner->user->mobile ?? ""}}</span>
                                        </div>
                                    </div>
                                </td>
