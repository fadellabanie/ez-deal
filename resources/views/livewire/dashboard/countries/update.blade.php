                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-6 fv-row">
                                    <x-input type="text" field="ar_name" wire:model="country.ar_name"
                                        placeholder="Arabic name" />
                                </div>
                                <div class="col-lg-6 fv-row">
                                    <x-input type="text" field="en_name" wire:model="country.en_name"
                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-switch fv-row">
                                <input class="form-check-input w-45px h-30px" type="checkbox" wire:model="country.status"
