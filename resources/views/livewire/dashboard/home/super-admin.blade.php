                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-warning hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-warning fw-bolder fs-2 mb-2 mt-5">{{$unReviewOrder}}</div>
                                <div class="fw-bold text-inverse-warning fs-7">{{__("Un Review Order")}}</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-3">
                        ...
                        <a href="#" class="card bg-info hoverable card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-info fw-bolder fs-2 mb-2 mt-5">{{$unReviewRealEstate}}</div>
