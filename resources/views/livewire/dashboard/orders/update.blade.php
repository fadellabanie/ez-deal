    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{__("Update Order")}}</h3>
            </div>
        </div>
            ...
            <form class="form">
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        <div class="row fv-row fv-plugins-icon-container">
                            <div class="col-lg-8">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" field="name" wire:model="order.name" placeholder="name" />
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <x-label class="required">{{__("Type")}}</x-label>
                                <div class="col-lg-12">
                                    <select class="form-select form-select-solid form-select-l" wire:model="order.type">
                    ...
                    <div class="row mb-6">
                        <div class="row fv-row fv-plugins-icon-container">
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="number" field="price" wire:model="order.price" placeholder="price" />
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <x-label class="required">{{__("Space")}}</x-label>
                                <div class="col-lg-12">
                                    <x-input type="text" field="space" wire:model="order.space" placeholder="space" />
                                </div>
                            </div>
                            <div class="col-lg-3">
                    ...
                    <div class="row mb-6">
                        <div class="row fv-row fv-plugins-icon-container">
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="number" field="number_building" wire:model="order.number_building"
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" field="age_building" wire:model="order.age_building"
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" field="street_width" wire:model="order.street_width"
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" field="street_number" wire:model="order.street_number"
                    ...
                    <div class="row mb-4">
                        <div class="row fv-row fv-plugins-icon-container">
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" field="type_of_owner" wire:model="order.type_of_owner"
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" field="number_card" wire:model="order.number_card"
                            ...
                            <div class="col-lg-3 ">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" field="note" wire:model="order.note" placeholder="note" />
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <x-label>{{__("Video Url")}}</x-label>
                                <div class="col-lg-12">
                                    <x-input type="text" field="video_url" wire:model="order.video_url"
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-switch fv-row">
                                <input class="form-check-input w-45px h-30px" type="checkbox" wire:model="order.elevator"
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-switch fv-row">
                                <input class="form-check-input w-45px h-30px" type="checkbox" wire:model="order.parking"
                                    id="allowmarketing" checked="checked" />
                                <label class="form-check-label" for="allowmarketing"></label>
                            </div>
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-switch fv-row">
                                <input class="form-check-input w-45px h-30px" type="checkbox" wire:model="order.ac"
                                    id="allowmarketing" checked="checked" />
                                <label class="form-check-label" for="allowmarketing"></label>
                            </div>
                        </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-switch fv-row">
                                <input class="form-check-input w-45px h-30px" type="checkbox" wire:model="order.furniture"
                                    id="allowmarketing" checked="checked" />
                                <label class="form-check-label" for="allowmarketing"></label>
                            </div>
                        </div>
                    ...
                    <div class="row mb-4">
                        <div class="row fv-row fv-plugins-icon-container">
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" disabled id="lat" field="lat" wire:model="order.lat"
                            ...
                            <div class="col-lg-3" wire:ignore>
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" disabled id="lng" field="lng" wire:model="order.lng"
                            ...
                            <div class="col-lg-3" wire:ignore>
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" disabled id="address" field="address" wire:model="order.address"
                                        placeholder="address" />
                                </div>
                            </div>
                            <div class="col-lg-3">
                                ...
                                <div class="col-lg-12">
                                    <x-input type="text" field="neighborhood" wire:model="order.neighborhood"
