                    ...
                    <table id="kt_profile_overview_table"
                        ...
                        <thead class="fs-7 text-gray-400 text-uppercase">
                            <tr role="row">
                                ...
                                <th wire:click="sortBy('type')" data-sort="{{$sortDirection}}" class="min-w-90px">
                                 ...
                                 <th wire:click="sortBy('package_id')" data-sort="{{$sortDirection}}" class="min-w-90px">
                                    {{__("Package")}}
                                    <x-sort field="package_id" sortBy="{{$sortBy}}" sortDirection="{{$sortDirection}}">
                                    </x-sort>
                                </th>  <th wire:click="sortBy('subscribe_to')" data-sort="{{$sortDirection}}" class="min-w-90px">
                                    {{__("Subscribe To")}}
                                    <x-sort field="subscribe_to" sortBy="{{$sortBy}}" sortDirection="{{$sortDirection}}">
                                    </x-sort>
                                </th>
                        ...
                        <tbody class="fs-6">
                            ...
                            <tr wire:loading.class="opacity-50">
                                ...
                                <td>{{$user->package->en_name}}</td>
                                <td>{{$user->subscribe_to}}</td>
