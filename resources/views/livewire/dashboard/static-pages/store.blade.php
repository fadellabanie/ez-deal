    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{__("Create Static Pages")}}</h3>
            </div>
        </div>
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-6 fv-row">
                                    <x-input type="text" field="ar_title" wire:model="ar_title"
                                        placeholder="Arabic title" />
                                </div>
                                <div class="col-lg-6 fv-row">
                                    <x-input type="text" field="en_title" wire:model="en_title"
