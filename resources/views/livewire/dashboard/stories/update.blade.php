    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">{{__("Update story")}}</h3>
            </div>
        </div>
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="date" field="story.start_date" wire:model="story.start_date"
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-8">
                            <div class="row">
                                <div class="col-lg-12 fv-row">
                                    <x-input type="date" field="story.end_date" wire:model="story.end_date"
                    ...
                    <div class="row mb-0">
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-switch fv-row">
                                <input class="form-check-input w-45px h-30px" type="checkbox" wire:model="story.status"
